...
import { ShaderWrapper } from "glazejs/src/glaze/graphics/render/util/ShaderWrapper"
import { CompileProgram } from "glazejs/src/glaze/graphics/render/util/WebGLShaderUtil"

// We import the original vertex shader,
// but then we use it with our custom fragment shader.
import vertexShader from "glazejs/src/glaze/graphics/render/tile/shaders/tileMap.vert.glsl"
